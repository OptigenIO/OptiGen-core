...
@pytest.fixture
def project_settings(temp_directory, sample_project_snapshot):
...
class TestInitialization:
    ...
    def test_init_creates_snapshot_if_none(self, temp_directory):
    ...
    def test_init_loads_existing_snapshot(self, temp_directory):
...
class TestProperties:
    ...
    def test_title_property_and_update(self, project_settings):
    ...
    def test_description_property_and_update(self, project_settings):
    ...
    def test_schema_definition_property_and_update(self, project_settings):
...
class TestUpdate:
    ...
    def test_update_method(self, project_settings):
...
class TestConstraints:
    ...
    def test_remove_constraint(self, project_settings):
    ...
    def test_update_constraint(self, project_settings):
...
class TestSchemaHelpers:
    ...
    def test_get_request_schema(self, project_settings):
        """Test get_request_schema helper."""
        schema = project_settings.get_request_schema()
        assert schema is not None
        assert "input" in schema["properties"]

    def test_get_response_schema(self, project_settings):
